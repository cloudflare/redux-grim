...
var startExtension = '.start';
var successExtension = '.success';
var errorExtension = '.error';
var setExtension = '.set';

var getStartType = function getStartType(entityType) {
  return '' + entityType + startExtension;
};
var getSuccessType = function getSuccessType(entityType) {
  return '' + entityType + successExtension;
};
var getErrorType = function getErrorType(entityType) {
  return '' + entityType + errorExtension;
};
var getSetType = function getSetType(entityType) {
  return '' + entityType + setExtension;
};
var isSuccessType = function isSuccessType(type) {
  return type.endsWith(successExtension);
};
var isSetType = function isSetType(type) {
  return type.endsWith(setExtension);
};
...
function makeReducer(entityType) {
  ...
  var startType = getStartType(entityType);
