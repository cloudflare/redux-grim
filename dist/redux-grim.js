  ...
  var reducer = function reducer() {
    ...
    switch (action.type) {
      case entityType + '.start':
        ...
        return seamlessImmutable_development_1.from(hooks.start(nextState, state, action, options));
      ...
      case entityType + '.success':
        ...
        return seamlessImmutable_development_1.from(hooks.success(nextState, state, action, options));
      ...
      case entityType + '.error':
        ...
        return seamlessImmutable_development_1.from(hooks.error(nextState, state, action, options));
